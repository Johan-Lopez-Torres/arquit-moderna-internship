...
const page = () => {
  return (
    <>
      <div className="h-screen flex flex-row px-20 py-12">
        <div className="w-1/2  h-full bg-teal-200">
          
    <div className="relative flex flex-col justify-center overflow-hidden">
        <div className="w-full p-6 m-auto bg-slate-950 rounded-md shadow-md ring-2 ring-gray-800/50 lg:max-w-xl">
        ...
        <div className="w-1/2 h-full bg-indigo-500">
          <img className="w-full h-full  object-cover object-left" src="https://www.mstholding.com/blog/wp-content/uploads/2020/03/iStock-808364658-e1584002771559.jpg" alt="" />
        </div>
      </div>
    </>
  );
