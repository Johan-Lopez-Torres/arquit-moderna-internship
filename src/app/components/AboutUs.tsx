...
const AboutUs = () => {
  return (
    <>
      <div className="min-h-screen lg:h-screen flex flex-col md:flex-row  p-10 gap-3">
        ...
        <div className=" w-full  md:w-1/2 bg-footer rounded-2xl p-6">
          ...
          <div className="flex flex-col  items-center gap-8  md:flex-row md:gap-12 justify-center  ">
            <div className="flex flex-col  gap-3 justify-center items-center md:w-32 sm:w-16">
              <h1 className="text-xl md:text-sm  font-bold text-center">
